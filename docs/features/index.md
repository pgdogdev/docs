...
| [Transaction mode](connection-pooler/transaction-mode.md) | Multiplex few PostgreSQL server connections between thousands of clients. |
...
| [Pub/Sub](connection-pooler/pub_sub.md) | Support for `LISTEN`/`NOTIFY` in transaction mode. |
